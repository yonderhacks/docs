...
project = 'Yonder Hacks'
copyright = '2022, Yonder Hacks'
author = 'Chika Onoh'
...
htmlhelp_basename = 'yonderhacksdoc'
...
latex_documents = [
    (master_doc, 'yonderhacks.tex', 'Yonder Hacks Documentation',
     'Yonder Hacks', 'manual'),
]
...
man_pages = [
    (master_doc, 'yonderhacks', 'Yonder Hacks Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'yonderhacks', 'Yonder Hacks Documentation',
     author, 'documentation', 'Merry bytes of Ultracogence',
     'Miscellaneous'),
]
...
html_context['github_user'] = 'yonderhacks'
